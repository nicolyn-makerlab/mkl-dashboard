...
// the same sensitive specifics (pricing, personal/health detail) that
// kept Granola off the dashboard entirely. First names are an explicit
// exception, only in "deliveredBy" - see resolveSenderLabel below.
//
...
Rules:
- Never include dollar amounts, exact numbers, or health/personal information.
- Only "deliveredBy" may contain a name - never put a name inside "title" or "outcome".
