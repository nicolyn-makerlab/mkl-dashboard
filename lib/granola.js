...
// The list endpoint only returns lightweight rows (id, title, owner,
// timestamps) - attendees and the AI summary only come back from fetching
// a note individually by ID.
